<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminArea.aspx.cs" Inherits="WebFormsTemplate.AdminArea" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:ListView ID="ListMessages" runat="server"
            ...
            DeleteMethod="ListMessages_DeleteItem"
