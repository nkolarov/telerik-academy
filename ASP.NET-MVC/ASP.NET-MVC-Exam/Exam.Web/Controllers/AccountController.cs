...
namespace Exam.Web.Controllers
{
    ...
    {
        private const int userInitialPoints = 10;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser() { UserName = model.UserName, Points = userInitialPoints }; // add aditional user properties here!!
