...
var persisters = (function () {
    ...
    var BattlePersister = Class.create({
        ...
        move: function (data, success, error) {
            ...
            httpRequester.postJSON(url, warriorData, success, error);
        },
        ...
        defend: function (data, success, error) {
            ...
            httpRequester.postJSON(url, data.unitId, success, error);
        },
    });

    var MessagesPersister = Class.create({
        init: function (rootUrl) {
            var url = this.rootUrl + "messages/";
        },
        unread: function (sucess, error) {
